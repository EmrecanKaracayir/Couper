...
val overCouponsHighRiskPredictionList = ArrayList<Int>()

val underCouponsLowRiskPredictionList = ArrayList<Int>()
val underCouponsNormalRiskPredictionList = ArrayList<Int>()
val underCouponsHighRiskPredictionList = ArrayList<Int>()

val favoriteCouponPredictionList = ArrayList<Int>()
...
fun algorithmPhase(fixture: Fixture, fixturePool: FixturePool) {
...
fun printAndSaveScorePredictions(fixture: Fixture, results: AlgorithmResults) {
    ...
    if (fixture.homeTeamScore != null && fixture.awayTeamScore != null) {
        ...
        if (fixture.homeTeamScore > fixture.awayTeamScore) {
            if (homeTeamPredictedScore > awayTeamPredictedScore) matchResultPredictionList.add(1)
        ...
        if (homeTeamPredictedScore == 0 || awayTeamPredictedScore == 0) {
            if (fixture.homeTeamScore == 0 || fixture.awayTeamScore == 0) kgPredictionList.add(1)
        ...
        if (totalGoals > results.overCouponHIGH_RISK) overCouponsHighRiskPredictionList.add(1)
        else overCouponsHighRiskPredictionList.add(0)

        // ? UNDER COUPONS PREDICTION
        if (totalGoals < results.underCouponLOW_RISK) underCouponsLowRiskPredictionList.add(1)
        else underCouponsLowRiskPredictionList.add(0)
        if (totalGoals < results.underCouponNORMAL) underCouponsNormalRiskPredictionList.add(1)
        else underCouponsNormalRiskPredictionList.add(0)
        if (totalGoals < results.underCouponHIGH_RISK) underCouponsHighRiskPredictionList.add(1)
